 ...
 * Manages URL synchronization with filter state
 * Uses Next.js router to update search parameters
 */
export const SearchAndFiltersClient = ({ children }: { children: (props: { searchBar: React.ReactNode, filterPanel: React.ReactNode }) => React.ReactNode }) => {
  ...
  const filterPanel = <FilterPanel filters={filters} onFiltersChange={handleFiltersChange} />

  return children({ searchBar, filterPanel })
}
